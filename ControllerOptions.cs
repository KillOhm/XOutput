    ...
    public partial class ControllerOptions : Form
    {
        ...
        public ControllerOptions(ControllerDevice device)
        {
            ...
            foreach (MultiLevelComboBox m in this.Controls.OfType<MultiLevelComboBox>())
            {
                ...
                for (int i = 1; i <= 3; i++)
                {
                    m.addOption("Axes", "Default Values", "Default=" + (-100+((i-1)*100)).ToString(), new byte[] { 20, (byte)(i - 1), (byte)ind });
                }
                ...
                case 1:
                    ...
                    switch (subtype)
                    {
                        ...
                        case 3:
                            return "IH" + s;
                        case 4:
                            return "DEF=" + (-100+(num-1)*100).ToString() + "%";
                    }
                    break;
                case 2:
